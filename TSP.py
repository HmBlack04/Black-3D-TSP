...
class TerrainTSPSolver:
    def __init__(self, board_size=20, num_cities=20, num_terrain_points=400):
    ...
    def generate_cities(self):
        ...
        for i in range(self.num_cities):
            x = round(random.uniform(3, self.board_size - self.board_size / 5), 2)
            y = round(random.uniform(3, self.board_size - self.board_size / 5), 2)
    ...
    def plot_solution(self, terrain_points, cities, optimal_path ):
...
solver.plot_solution(terrain, cities, path)
